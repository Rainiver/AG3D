...
if __name__ == "__main__":
    ...
    # root = '/data/vdd/zhongyuhe/workshop/dataset/DeepFashion/images'
    ...
    save_dir = 'tmp_mesh/human_eva3d'
    os.makedirs(save_dir, exist_ok=True)
    # smpl_path = '/data/vdd/zhongyuhe/workshop/EVA3D/datasets/DeepFashion/smpl.pkl'
    smpl_path = '/data/vdd/zhongyuhe/workshop/dataset/human_syn/smpl.pkl'
